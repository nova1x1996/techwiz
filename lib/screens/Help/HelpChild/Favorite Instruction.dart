...
class FavoriteInstruction extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _FavoriteInstructionState();
}

class _FavoriteInstructionState extends State<FavoriteInstruction> {
  @override
