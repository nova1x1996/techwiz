...
class MenuInstruction extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _LoginInstructionState();
}

class _LoginInstructionState extends State<MenuInstruction> {
  @override
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              _buildInstructionStep(
                title: 'Step 4: Menu',
                description: 'Finally, you will see the menu at right top corner.',
                imagePath: 'assets/images/Help/Menu.jpg',
              ),
            ],
          ),
        ),
